...
- `tests/validate_physics.py`, `tests/validate_api.py`, `tests/validate_queue.py`: numerical, recovery, and queue checks (write `*_r4.json` / `queue_validation.json`; never overwrite historical `validation.json` / `validation_r3.json`).
