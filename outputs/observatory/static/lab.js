...
const DRAFT_KEY='orbital-lab-draft-v3',ACTIVE=['running','initializing','pausing'];
...
loadDraft();$('notes').value='From Cursor, Grok 4.6: two-phase ISM (revision 5)';setMode(mode);schedule();poll();
