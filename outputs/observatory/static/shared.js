...
export const GALAXY_SLIDERS=[
  ...
  {id:'ism_enabled',group:'Interstellar medium',label:'Two-phase ISM',kind:'bool',default:true,hint:'Grid pressure, ram drag, CIE-like cooling and blastwave-delayed SN heat on gas parcels. Not SPH. Needs the stellar lifecycle.'},
...
export function engineRamGb(cfg){return cfg.mode==='planets'?.12:.15+cfg.n*7e-7*(cfg.lifecycle_enabled?(cfg.ism_enabled!==false?1.35:1.2):1)}
